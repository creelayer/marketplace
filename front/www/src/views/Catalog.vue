  ...
  <div class="container-xxl">
    ...
    <div class="row">
      ...
      <div class="col-9">
        ...
        <div class="row">
          <div class="col-3 item" v-for="product in products" :key="product.id">
...
export default {
  ...
  methods: {
    fetchProducts: function () {
      ...
      Http.get(this._getUrl('/v1/product/search' + (this.alias ? '/' + this.alias : '')))
          .then(res => {
    ...
    preview: function (product) {
      return Config.IMAGE.DOMAIN + '/files/' + Config.IMAGE.CATALOG_PREVIEW + '/' + product.image
    }
  }
}
</script>
